...
_LittleSpecForce = pow(_LittleSpecForce, gamma) * 1.5;
					...
					_Specular3 = pow(_Specular3,gamma);
								...
								*/
								...
								half3 normalTex = UnpackScaleNormal(_NormalTex.Sample(my_linear_repeat_sampler, i.uv * _IceScale), _NormalScale);
					#endif
								...
								float3 newRoughnessTex = _Roughness.Sample(my_linear_repeat_sampler, i.uv * _IceScale).rgb;
								float alphaIce = 1;
								...
								float4 littleSpec = _LittleSpec.Sample(my_linear_repeat_sampler, i.uv * _SnowScale) * saturate(1 - ripples3);
					#endif
								...
								smallSpec = saturate(smallSpec * saturate(UnpackScaleNormal(_NormalTex.Sample(my_linear_repeat_sampler, i.uv * _IceScale), 20) + 0.8));
